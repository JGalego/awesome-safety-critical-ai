...
* [`zama-ai/concrete-ml`](https://github.com/zama-ai/concrete-ml): a Privacy-Preserving Machine Learning (PPML) open-source set of tools built on top of Concrete by Zama
